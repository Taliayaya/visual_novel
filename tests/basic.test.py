#!/usr/bin/env python3
from visual_novel.interpreter import getChoices, getDialogue, getBackground, getDescription
import unittest
...
class BasicTests(unittest.TestCase):
    ...
    def test_getDialogue_without_chr_img(self):
        ...
        expectOutput = {"type":"dialogue", "name": "Obiwan Kenobi", "image": '', "text":"Hello there"}
    ...
    def test_getDialogue_with_chr_img(self):
        ...
        expectOutput = {"type":"dialogue", "name": "Obiwan Kenobi", "image":["truejesus.png", "l"], "text":"Hello there !"}
        result = getDialogue(testTxt)
        self.assertDictEqual(result, expectOutput)
    ...
    def test_getDescription(self):
        ...
        expectOutput = {"type":"description", "name":'', "text":"I use Arch btw"}
